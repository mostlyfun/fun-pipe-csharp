...
public static class Extensions
{
    ...
    /// <summary>
    /// Opt counterpart of FirstOrDefault, which returns the first non-null element if <paramref name="collection"/> has any, None otherwise.
    /// </summary>
    ...
    /// <summary>
    /// Opt counterpart of FirstOrDefault, which returns the first Some element if <paramref name="collection"/> has any, None otherwise.
    /// </summary>
